...
@section('active-list-customer','active')
@section('show-list','show')
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header text-center" style="font-size: 30px;">Danh sách tài khoản Khách hàng</h1>
        </div>
    </div>
                ...
                <tr class="odd gradeX row-item" id="row-item-{{$item->id}}">
                    ...
                    <td class="black-icon" style="text-align: center">
                        <a href="#" class="fa fa-lock quick-lock mr-2"
                           data-customer="{{$item->id}}" data-status="{{$item->status}}"></a>
                    </td>
                </tr>
            @endforeach
            </tbody>
